# Sunrise Sunset API - Examples

This folder contains example code for using the Sunrise Sunset API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/sunrisesunset',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/sunrisesunset](https://docs.apiverve.com/ref/sunrisesunset)
