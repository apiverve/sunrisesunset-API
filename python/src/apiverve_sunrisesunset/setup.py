...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/sunrisesunset',
        'Source': 'https://github.com/apiverve/sunrisesunset-api',
        'Bug Tracker': 'https://github.com/apiverve/sunrisesunset-api/issues'
    },
    classifiers=[
