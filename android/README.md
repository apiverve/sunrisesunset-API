...
```gradle
dependencies {
    implementation 'com.github.apiverve:sunrisesunset-api:1.1.12'
}
```
...
```java
import com.apiverve.sunrisesunset.SunriseSunsetAPIClient;
import com.apiverve.sunrisesunset.APIResponse;
import com.apiverve.sunrisesunset.APIException;

// Initialize the client
SunriseSunsetAPIClient client = new SunriseSunsetAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/sunrisesunset](https://docs.apiverve.com/ref/sunrisesunset)
...
- **Documentation:** [https://docs.apiverve.com/ref/sunrisesunset](https://docs.apiverve.com/ref/sunrisesunset)
- **Issues:** [GitHub Issues](https://github.com/apiverve/sunrisesunset-api/issues)
